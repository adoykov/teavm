...
public class TDerOutputStream
        extends ByteArrayOutputStream implements TDerEncoder {
    /**
     * Construct an DER output stream.
     *
     * @param size how large a buffer to preallocate.
     */
    public TDerOutputStream(int size) { super(size); }
     ...
     */
    public void write(byte tag, TDerOutputStream out) throws IOException {
        write(tag);
        putLength(out.count);
     ...
     */
    public void writeImplicit(byte tag, TDerOutputStream value)
            throws IOException {
        write(tag);
     ...
     */
    public void putDerValue(TDerValue val) throws IOException {
        val.encode(this);
    }
    ...
    public void putEnumerated(int i) throws IOException {
        write(TDerValue.tag_Enumerated);
     ...
     */
    public void putUnalignedBitString(TBitArray ba) throws IOException {
     ...
     * @param ba the bit string, MSB first
     */
    public void putTruncatedUnalignedBitString(TBitArray ba) throws IOException {
    ...
    public void putOctetString(byte[] octets) throws IOException {
        write(TDerValue.tag_OctetString, octets);
    }
     ...
     */
    public void putOID(TObjectIdentifier oid) throws IOException {
        oid.encode(this);
    }
     ...
     */
    public void putSequence(TDerValue[] seq) throws IOException {
        TDerOutputStream bytes = new TDerOutputStream();
        int i;
        ...
        write(TDerValue.tag_Sequence, bytes);
    }
     ...
     */
    public void putSet(TDerValue[] set) throws IOException {
        TDerOutputStream bytes = new TDerOutputStream();
        int i;
     ...
     */
    public void putOrderedSetOf(byte tag, TDerEncoder[] set) throws IOException {
     ...
     */
    public void putOrderedSet(byte tag, TDerEncoder[] set) throws IOException {
     ...
     */
    private void putOrderedSet(byte tag, TDerEncoder[] set,
            Comparator<byte[]> order) throws IOException {
        TDerOutputStream[] streams = new TDerOutputStream[set.length];

        for (int i = 0; i < set.length; i++) {
            streams[i] = new TDerOutputStream();
    ...
    public void putUTF8String(String s) throws IOException {
        writeString(s, TDerValue.tag_UTF8String, "UTF8");
    }
    ...
    public void putPrintableString(String s) throws IOException {
        writeString(s, TDerValue.tag_PrintableString, "ASCII");
    }
    ...
    public void putT61String(String s) throws IOException {
         ...
         * T61.
         */
        writeString(s, TDerValue.tag_T61String, "ISO-8859-1");
    }
    ...
    public void putIA5String(String s) throws IOException {
        writeString(s, TDerValue.tag_IA5String, "ASCII");
    }
    ...
    public void putBMPString(String s) throws IOException {
        writeString(s, TDerValue.tag_BMPString, "UnicodeBigUnmarked");
    }
    ...
    public void putGeneralString(String s) throws IOException {
        writeString(s, TDerValue.tag_GeneralString, "ASCII");
    }
    ...
    public void putUTCTime(Date d) throws IOException {
        putTime(d, TDerValue.tag_UtcTime);
    }
    ...
    public void putGeneralizedTime(Date d) throws IOException {
        putTime(d, TDerValue.tag_GeneralizedTime);
    }
    ...
    private void putTime(Date d, byte tag) throws IOException {
        ...
        if (tag == TDerValue.tag_UtcTime) {
            pattern = "yyMMddHHmmss'Z'";
        } else {
            tag = TDerValue.tag_GeneralizedTime;
