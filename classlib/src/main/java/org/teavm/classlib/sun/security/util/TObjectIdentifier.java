...
public final
class TObjectIdentifier implements Serializable
{
    /*
     ...
     * @serial
     */
    private Object      components;          // path from root
    /**
     * @serial
     */
    ...
    private void writeObject(ObjectOutputStream os)
        ...
        if (!componentsCalculated) {
            ...
            if (comps != null) {    // every one understands this
                ...
                components = TObjectIdentifier.HugeOidNotSupportedByOldJDK.theOne;
            }
    ...
    static class HugeOidNotSupportedByOldJDK implements Serializable {
        ...
        static TObjectIdentifier.HugeOidNotSupportedByOldJDK
                theOne = new TObjectIdentifier.HugeOidNotSupportedByOldJDK();
    }
     ...
     */
    public TObjectIdentifier(String oid) throws IOException
    {
        int ch = '.';
        int start = 0;
        int end = 0;
     ...
     * Validity check included.
     */
    public TObjectIdentifier(int[] values) throws IOException
    {
     ...
     */
    public TObjectIdentifier(TDerInputStream in) throws IOException
    {
        byte    type_id;
        int     bufferEnd;
        ...
        if (type_id != TDerValue.tag_ObjectId) {
     ...
     * Validity check NOT included.
     */
    TObjectIdentifier(TDerInputBuffer buf) throws IOException
    {
        TDerInputStream in = new TDerInputStream(buf);
     ...
     */
    public static TObjectIdentifier newInternal(int[] values) {
        try {
            return new TObjectIdentifier(values);
     ...
     */
    void encode (TDerOutputStream out) throws IOException
    {
        out.write (TDerValue.tag_ObjectId, encoding);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TObjectIdentifier == false) {
            return false;
        }
        TObjectIdentifier other = (TObjectIdentifier)obj;
